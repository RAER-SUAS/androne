...
final class Board extends Enum
{
    static class Hardware
    {
        ...
        static 
        {
            ...
            ai[1] = 2;
            ai[2] = 4;
            IOIO0002 = new Hardware(((boolean [][]) (obj)), 9, 4, 3, ai, new int[] {
                6, 7, 8
            }, new int[][] {
                new int[] {
                    4, 5
            ...
            IOIO0004 = new Hardware(aflag, 9, 4, 3, ai, new int[] {
                6, 7, 8
            }, new int[][] {
                ai1, new int[] {
                    1, 2
        ...
        private Hardware(boolean aflag[][], int i, int j, int k, int ai[], int ai1[], int ai2[][], 
                int ai3[])
        {
            if (aflag == null)
            {
    ...
    private static final class Hardware.Function extends Enum
    {

        public static final Hardware.Function ANALOG_IN;
        private static final Hardware.Function ENUM$VALUES[];
        public static final Hardware.Function PERIPHERAL_IN;
        public static final Hardware.Function PERIPHERAL_OUT;

        public static Hardware.Function valueOf(String s)
        {
            return (Hardware.Function)Enum.valueOf(ioio/lib/impl/Board$Hardware$Function, s);
        }

        public static Hardware.Function[] values()
        {
            Hardware.Function afunction[] = ENUM$VALUES;
            int i = afunction.length;
            Hardware.Function afunction1[] = new Hardware.Function[i];
        ...
        static 
        {
            PERIPHERAL_OUT = new Hardware.Function("PERIPHERAL_OUT", 0);
            PERIPHERAL_IN = new Hardware.Function("PERIPHERAL_IN", 1);
            ANALOG_IN = new Hardware.Function("ANALOG_IN", 2);
            ENUM$VALUES = (new Hardware.Function[] {
                PERIPHERAL_OUT, PERIPHERAL_IN, ANALOG_IN
            });
        }

        private Hardware.Function(String s, int i)
        {
            super(s, i);
        }
    }
    ...
    private static final Board ENUM$VALUES[];
    public static final Board MINT0010;
    public static final Board SPRK0015;
    public static final Board SPRK0016;
    public static final Board SPRK0020;
    public final Hardware hardware;

    private Board(String s, int i, Hardware hardware1)
    {
        super(s, i);
        hardware = hardware1;
    }
    ...
    {
        return (Board)Enum.valueOf(ioio/lib/impl/Board, s);
    }

    public static Board[] values()
    {
        Board aboard[] = ENUM$VALUES;
        int i = aboard.length;
        Board aboard1[] = new Board[i];
        System.arraycopy(aboard, 0, aboard1, 0, i);
        return aboard1;
    }

    static 
    {
        SPRK0015 = new Board("SPRK0015", 0, Hardware.IOIO0002);
        SPRK0016 = new Board("SPRK0016", 1, Hardware.IOIO0003);
        MINT0010 = new Board("MINT0010", 2, Hardware.IOIO0003);
        SPRK0020 = new Board("SPRK0020", 3, Hardware.IOIO0004);
        ENUM$VALUES = (new Board[] {
            SPRK0015, SPRK0016, MINT0010, SPRK0020
        });
    }
}
