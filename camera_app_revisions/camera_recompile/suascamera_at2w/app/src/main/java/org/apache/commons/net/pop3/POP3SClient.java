...
public class POP3SClient extends POP3Client
{
    ...
    public POP3SClient(String s)
    {
        this(s, false);
    }

    public POP3SClient(String s, boolean flag)
    {
        this(s, flag, null);
    }

    public POP3SClient(String s, boolean flag, SSLContext sslcontext)
    {
        context = null;
        suites = null;
        protocols = null;
    ...
    public POP3SClient(boolean flag)
    {
        this("TLS", flag);
    }

    public POP3SClient(boolean flag, SSLContext sslcontext)
    {
