...
public final class FTPCommand
{
    ...
    static void checkArray()
    {
        ...
        {
            throw new RuntimeException((new StringBuilder()).append("Incorrect _commands array. Should have length ").append(40).append(" found ").append(_commands.length).toString());
        } else
        {
            return;
        }
