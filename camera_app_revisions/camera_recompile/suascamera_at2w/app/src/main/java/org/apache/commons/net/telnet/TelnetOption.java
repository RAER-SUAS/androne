...
public class TelnetOption
{
    ...
    private static final String __optionString[] = {
        ...
        "X.3 PAD", "NAWS", "TSPEED", "LFLOW", "LINEMODE", "XDISPLOC", "OLD-ENVIRON", "AUTHENTICATION", "ENCRYPT", "NEW-ENVIRON", 
    ...
    public static final String getOption(int i)
    {
        if (__optionString[i].length() == 0)
        {
            return "UNASSIGNED";
        } else
        {
            return __optionString[i];
        }
    }

    public static final boolean isValidOption(int i)
    {
        return i <= 255;
    }
